...
struct BookmarkView: View {
    ...
    @Query(sort: \Bookmark.createdAt, order: .reverse) var bookmarks:
        [Bookmark]  // 북마크 불러오기
        ...
        NavigationStack {
            HStack {
                ...
                ScrollView {  //navigationView
                    ...
                    ForEach( /*reorderedBookmarks*/bookmarks, id: \.self) {
                        bookmark in
                        if let content = bookmark.content {
                            ...
                            .background(Color.backGround)  // 북마크 블럭
                        }
